...
var dataType = u.difference(dataType, dataTypes_inManifestXena_notInXena).splice(16, 10);
...
connection.once('open', function(){
    ...
    }, function (err)
    {
        ...
        jsonfile.writeFile("/usr/local/airflow/docker-airflow/onco-test/dataStr/ajv_test2_pi3.json", ajvMsg_v2, {spaces:4}, function(err){ console.error(err);});
        connection.close();
    });
