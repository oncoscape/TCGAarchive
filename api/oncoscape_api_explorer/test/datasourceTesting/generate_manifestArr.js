...
co(function *() {
  ...
  jsonfile.writeFile("/Users/zhangj4/Desktop/canaantt_git/oncoscape_api_explorer/test/manifest_arr.json", manifest_arr, {spaces: 2}, function(err){ console.error(err);});  
  jsonfile.writeFile("/Users/zhangj4/Desktop/canaantt_git/oncoscape_api_explorer/test/lookup_arr.json", lookup_arr, {spaces: 2}, function(err){ console.error(err);});  
  jsonfile.writeFile("/Users/zhangj4/Desktop/canaantt_git/oncoscape_api_explorer/test/render_pca.json", render_pca, {spaces: 2}, function(err){ console.error(err);});  
  jsonfile.writeFile("/Users/zhangj4/Desktop/canaantt_git/oncoscape_api_explorer/test/render_patient.json", render_patient, {spaces: 2}, function(err){ console.error(err);});  
  console.timeEnd();
